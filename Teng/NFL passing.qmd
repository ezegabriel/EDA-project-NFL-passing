...
ggplot(nfl_passing_stats, aes(x = avg_yards_gained, y = interception_rate, color = cluster)) +
...
ggplot(nfl_passing_stats, aes(x = completion_rate, y = interception_rate, color = cluster)) +
  geom_point(size = 2, alpha = 0.5) +
  ggthemes::scale_color_colorblind() +  # using colorblind-friendly palette
  labs(title = "NFL QBs Clustering Based on Performance Metrics",
       x = "Completion Rate (%)",
